...
if (country_name=="United States") {
  ...
  jhu_dataset <- read.csv(paste0(paste0("/home/natraj/neural_network/covid/covARC/filtered/US/",region),".csv"))
  ...
  jhu_dataset <- read.csv(paste0(paste0("/home/natraj/neural_network/covid/covARC/filtered/",country_name),".csv"))
  jhu_dataset <- jhu_dataset %>% mutate_if(is.character,as.factor)
  jhu_dataset$Date<-as.Date(as.character(jhu_dataset$Date),format="%Y-%m-%d")
...
ratio_dataset <- read.csv("/home/natraj/neural_network/covid/Ratios_Survey.csv")
...
for (date_1 in jhu_dataset_date$date){
  ...
  mask <- read.csv("/home/natraj/neural_network/covid/mask.csv") #Ref: https://www.epa.gov/sciencematters/epa-researchers-test-effectiveness-face-masks-disinfection-methods-against-covid-19
  ...
  summary(mask)
  vaccine_eff <- read.csv("/home/natraj/neural_network/covid/vaccine_eff.csv", sep = ",") #Ref: https://yourlocalepidemiologist.substack.com/p/vaccine-table-update-lots-on-delta
  ...
  #================data pulling script======================== 
  variants_dataset <- read_csv(paste0(paste0("/home/natraj/neural_network/covid/processed/",country_name),".csv"),show_col_types = FALSE)
...
write.csv(graphical,'delhi_india_60_no_safety.csv')
...
write.csv(graphical,'franklin_usa_30_no_vaccine_n95.csv')
...
type_vaccine_dose = "Pfizer (Dose 1)"
...
write.csv(graphical,'franklin_usa_30_m1_no_mask.csv')
...
type_vaccine_dose = "Pfizer (Dose 2)"
...
write.csv(graphical,'franklin_usa_30_m2_no_mask.csv')
...
type_vaccine_dose = "Pfizer (Dose 2) + Pfizer Booster"#"Moderna (Dose 2)"
...
write.csv(graphical,'franklin_usa_30_m3_no_mask.csv')
